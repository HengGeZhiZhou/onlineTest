...
<body>
<form action="<%=request.getContextPath()%>onlineTest/students/uploadStudents" enctype="multipart/form-data" method="post" class="box login">
    ...
    <footer>
        <input type="submit" class="btnLogin" value="批量导入学生" tabindex="4">
    </footer>
</form>
